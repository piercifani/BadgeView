...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    /*
        One of the cool features of the SBBarButtonItem is that it blends with the UINavigationBar tintColor,
        You can customize that look here in order to test this feature
     */
